...
export const updateOrder = (orderId, order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      `http://localhost:3001/order/update/${orderId}`,
      order,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
...
export const cancelOrder = (orderId) => async (dispatch, getState) => {
  try {
    const { data } = await axios.post(
      `http://localhost:3001/order/cancel/${orderId}`,
    );
...
//       userSignin: { userInfo },
//     } = getState();
//     const { data } = await axios.get(`http://localhost:3001/order/orderPaypal`, {
//       headers: {
//         Authorization: `Bearer ${userInfo.token}`,
//       },
//     });
...
export const GetAllOrderPendding = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `http://localhost:3001/order/orderPendding`,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
        },
...
export const GetAllOrderShipping = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `http://localhost:3001/order/orderShipping`,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
        },
...
export const GetAllOrderPaid = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/order/orderPaid`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const deleteOrder = (orderId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://localhost:3001/order/delete/${orderId}`,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
        },
...
export const ShippingOrder = (orderId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:3001/order/shipping/${orderId}`,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
        },
...
export const PaidOrder = (orderId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:3001/order/paid/${orderId}`,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
        },
...
export const getOrderByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/order/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const getOrderPenddingByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/order/orderPendding/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const getOrderShippingByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/order/orderShipping/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const getOrderPaidByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/order/orderPaid/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const payOrder = (order, paymentResult) => async (dispatch, getState) => {
    ...
    try {
      const { data } = axios.put(
        `http://localhost:3001/order/pay/${order._id}`,
        paymentResult,
        {
